      ...
      <div className="relative z-10 max-w-md w-full px-6">
        ...
        >
          ...
          <motion.button
            ...
            disabled={isLoading}
            className="w-full py-4 bg-white border-4 border-black rounded-2xl font-black text-lg text-black shadow-[0_6px_0_rgba(0,0,0,0.8)] active:translate-y-1 transition-all flex items-center justify-center gap-3 disabled:opacity-60"
          >
            {isLoading ? (
              <span className="animate-pulse">ENTERING THE ARENA...</span>
            ) : (
              <>
                <GoogleIcon size={24} />
