...
export default function Loading() {
  ...
  const loadingTips = [
    ...
    '⚡ Tip: Complete quizzes correctly to gain focus faster!',
    '🔥 Tip: Discovery payouts give instant focus boosts!',
    '🎯 Tip: Save boosts for critical moments!',
    '💪 Tip: Chain videos together for combo multipliers!',
    '🧠 Tip: Higher rot = stronger attacks but worse defense!',
  ];
    ...
    <div className="h-screen relative text-white overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[...Array(20)].map((_, i) => (
          <motion.div
            ...
            style={{
              backgroundColor: ['#39FF14', '#7B2CBF', '#4CC9F0', '#FFD60A'][Math.floor(Math.random() * 4)],
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <motion.div
          ...
          className="absolute w-64 h-64 border-4 border-[#7B2CBF]/20 rounded-full"
        />
        <motion.div
          animate={{ rotate: -360 }}
          transition={{ duration: 6, repeat: Infinity, ease: 'linear' }}
          className="absolute w-80 h-80 border-4 border-[#39FF14]/20 rounded-full"
        />
        <motion.div
          animate={{ rotate: 360 }}
          transition={{ duration: 10, repeat: Infinity, ease: 'linear' }}
          className="absolute w-96 h-96 border-4 border-[#4CC9F0]/20 rounded-full"
        />
      </div>
