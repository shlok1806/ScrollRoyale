          ...
          <AnimatePresence mode="wait">
            ...
            {phase === 'searching' && (
              ...
              >
                ...
                <p className="text-white/70 font-bold">Finding worthy opponent</p>
              </motion.div>
            )}
              ...
              >
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    >
                      <div className="bg-[#FF006E] border-4 border-black rounded-2xl p-4 shadow-[0_6px_0_rgba(0,0,0,0.8)]">
                        <div className="flex items-center gap-3 mb-3">
                          <div className="w-16 h-16 bg-black/20 rounded-xl border-2 border-black flex items-center justify-center overflow-hidden">
                            <BrainCharacter customization={opponent.customization} size={48} rotLevel={opponent.rotLevel} />
                          </div>
                          <div className="flex-1 min-w-0">
                            <h3 className="font-black text-sm text-white truncate">{opponent.name}</h3>
                            <p className="text-xs text-white/70 font-bold">Rank #{opponent.rank}</p>
                          </div>
                        </div>
                        <div className="space-y-1">
                          <StatRow label="ROT" value={`${opponent.rotLevel}%`} color="text-[#FFD60A]" />
                          <StatRow label="WINS" value={opponent.wins.toString()} color="text-white" />
                        </div>
                      </div>
                    </motion.div>
                  </div>
                ...
                >
                  <div className="grid grid-cols-3 gap-3 text-center">
                    <div>
                      <div className="text-2xl font-black text-[#39FF14]">60s</div>
