...
import { TrophyIcon, CrownIcon, GlobeIcon, UserGroupIcon } from '../../shared/components/GameIcons';
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-14 h-14 rounded-full bg-[#FFD60A] border-3 border-black flex items-center justify-center overflow-hidden shadow-[0_3px_0_rgba(0,0,0,0.6)]">
                <BrainCharacter rotLevel={20} size={48} showArms={false} customization={customization} />
              </div>
